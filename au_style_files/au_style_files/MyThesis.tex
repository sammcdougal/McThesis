...
Current LEO constellations were not designed for navigation, specifically. Most are used for satellite communications, 
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=3.5in]{MeasurementGenBlockDiagram}
